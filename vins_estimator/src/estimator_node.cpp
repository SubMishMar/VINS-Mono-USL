...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber sub_image = n.subscribe("/feature_tracker/feature", 50, feature_callback);
    ros::Subscriber sub_raw_image = n.subscribe(IMAGE_TOPIC, 50, raw_image_callback);
